...
## Corpus Check
- 53 files · ~53,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 439 nodes · 537 edges · 32 communities (26 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5dea2b98`
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (36): App(), Layout(), LiveAssessmentModalProps, Navbar(), PinScreen(), PinScreenProps, supabase, AddLog() (+28 more)
...
Cohesion: 0.10
Nodes (27): DeleteQModalState, LibraryManager(), LockModalState, moduleTypeLabel(), moduleTypePillClass(), ModuleWithCount, QuestionCardProps, CounselingLog (+19 more)
...
Cohesion: 0.26
Nodes (12): getAvailableCapacityForDateRange(), getCapacityMap(), getDailyCapacity(), getDateLoad(), getDateStatus(), getSessionCountsForDateRange(), toLocalDateStr(), BulkSchedule() (+4 more)
...
Cohesion: 0.26
Nodes (9): AssessmentWizard(), AssessmentWizardProps, AssessmentQuestion, buildAssessmentSummary(), computeModuleScore(), effectiveScore(), fetchAssessmentQuestions(), reverseScore() (+1 more)
